...
The directories generated by this workflow are partitioned in such a way to distinguish their individual contributions to the workflow. They are all housed under the 'results/' directory:
...
This folder (results/summary/Editing) contains information relevant to quantitating allele frequencies and 
